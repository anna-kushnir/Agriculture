...
/**
 * FieldActivityAdapter is responsible for what information is displayed in ListView entries.
 */
public class FieldActivityAdapter extends ArrayAdapter<Field> {

    private LayoutInflater inflater;
    private Context context;

    public FieldActivityAdapter(Context context, ArrayList<Field> fields) {
